    ...
    <section className="py-24 bg-bg-default">
      <div className="container mx-auto px-6 max-w-4xl text-center">
        <p className={`font-sans text-2xl md:text-[28px] leading-9 text-text-primary italic mb-12`}>
          ...
          whitening solutions.&rdquo;
        </p>

        <div className="flex flex-col items-center">
          <div className="h-px w-24 bg-neutral-50 mb-6" />
          <h3 className={ds.headingSection}>Lucy Luminous</h3>
          <p className={`${ds.labelCaps} mt-3 text-text-muted`}>Founder & Chief Shine Officer</p>
        </div>
      </div>
    </section>
  );
